...
GLFWbool _glfwConnectWebrogue(int platformID, _GLFWplatform* platform)
{
    const _GLFWplatform wr =
    {
        ...
        .pollEvents = _glfwPollEventsWebrogue,
        .waitEvents = _glfwWaitEventsWebrogue,
        .waitEventsTimeout = _glfwWaitEventsTimeoutWebrogue,
        .postEmptyEvent = _glfwPostEmptyEventNull,
        .getEGLPlatform = _glfwGetEGLPlatformNull,
        .getEGLNativeDisplay = _glfwGetEGLNativeDisplayWebrogue,
        .getEGLNativeWindow = _glfwGetEGLNativeWindowWebrogue,
        .getRequiredInstanceExtensions = _glfwGetRequiredInstanceExtensionsWebrogue,
