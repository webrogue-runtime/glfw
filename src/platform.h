...
#if defined(_GLFW_WEBROGUE)
 #include "wr_platform.h"
#else
 #define GLFW_WEBROGUE_WINDOW_STATE
 #define GLFW_WEBROGUE_MONITOR_STATE
 #define GLFW_WEBROGUE_CURSOR_STATE
 #define GLFW_WEBROGUE_LIBRARY_WINDOW_STATE
 #define GLFW_WEBROGUE_CONTEXT_STATE
 #define GLFW_WEBROGUE_LIBRARY_CONTEXT_STATE
#endif
